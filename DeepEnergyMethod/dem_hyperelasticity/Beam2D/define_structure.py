...
from DeepEnergyMethod.dem_hyperelasticity.Beam2D.config import *

#import numpy as np
#import matplotlib.pyplot as plt

def setup_domain(traction_x=0, traction_y=0): # Jonathan introduced traction_y and traction_x to overvreite the default values
    ...
    ### Jonathan ###
    known_right_tx = traction_x
    known_right_ty = traction_y
    ################
